...
architecture behavior of cpu is
	...
	component pmp
		port(
			reset           : in  std_logic;
			clock           : in  std_logic;
			pmp_mem_valid   : in  std_logic;
			pmp_mem_instr   : in  std_logic;
			pmp_mem_ready   : out std_logic;
			pmp_mem_addr    : in  std_logic_vector(63 downto 0);
			pmp_mem_wdata   : in  std_logic_vector(63 downto 0);
			pmp_mem_wstrb   : in  std_logic_vector(7 downto 0);
			pmp_mem_rdata   : out std_logic_vector(63 downto 0)
		);
	end component;
	...
	component interconnect
		port(
			...
			-- PMP
			pmp_mem_valid   : out std_logic;
			pmp_mem_instr   : out std_logic;
			pmp_mem_ready   : in  std_logic;
			pmp_mem_addr    : out std_logic_vector(63 downto 0);
			pmp_mem_wdata   : out std_logic_vector(63 downto 0);
			pmp_mem_wstrb   : out std_logic_vector(7 downto 0);
			pmp_mem_rdata   : in  std_logic_vector(63 downto 0);
			-- TIMER
